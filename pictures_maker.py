...
dst13 = dst_list(13)
print(dst13)
src4,dst4 = del_loops(src12,dst12)
src5,dst5 = del_loops(src13,dst13)
    
graph12 = dgl.graph((src12,dst12))
graph13 = dgl.graph((src13,dst13))


t = torch.linspace(0,1.27,128)

x12 = torch.load("nbody_12_traj.pt")
print(x4.shape)
h12 = torch.load("nbody_12_H.pt")
print(h4.shape)
x13 = torch.load("nbody_13_traj.pt")
print(x5.shape)
h13 = torch.load("nbody_13_H.pt")
print(h5.shape)
